package com.colipu.huaweideployment.service.impl;

import com.colipu.huaweideployment.service.IDockerService;
import com.colipu.huaweideployment.util.AliCloudDockerManager;
...
@Slf4j
@Service("AliCloud")
public class DockerServiceAliImpl implements IDockerService {

    @Autowired
    private AliCloudDockerManager dockerManager;
